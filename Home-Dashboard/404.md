...
<head>
    <script>
        ...
        if (account == null) {
            ...
            location.href = "https://bullrunv5.github.io/signin";
        }
    </script>
    <!-- Meta data -->
    <meta charset="UTF-8">
    ...
    <link rel="shortcut icon" type="image/x-icon" href="https://bullrunv5.github.io/signup/assets/img/bullrun3.png">
    ...
    <!-- Bootstrap css -->
    <link href="https://bullrunv5.github.io/bootstrap.min.css" rel="stylesheet" />

    <!-- Style css -->
    <link href="https://bullrunv5.github.io/css.style.css" rel="stylesheet" />

    <!-- Default css -->
    <link href="https://bullrunv5.github.io/default.css" rel="stylesheet">

    <!-- Sidemenu css-->
    <link rel="stylesheet" href="https://bullrunv5.github.io/sidemenu.css">

    <!-- Bootstrap-daterangepicker css -->
    <link rel="stylesheet" href="https://bullrunv5.github.io/daterangepicker.css.html">

    <!-- Bootstrap-datepicker css -->
    <link rel="stylesheet" href="https://bullrun.live/Content/assets/plugins/bootstrap-datepicker/bootstrap-datepicker.css">

    <!-- Custom scroll bar css -->
    <link href="https://bullrunv5.github.io/jquery.mCustomScrollbar.css" rel="stylesheet" />

    <!-- Sidemenu-repsonsive-tabs  css -->
    <link href="https://bullrunv5.github.io/sidemenu-responsive-tabs.css" rel="stylesheet">
                    ...
                    <div class="first-sidemenu">
                        <div class="line-animations">
                            <ul class="resp-tabs-list hor_1">
                                ...
                                <li class="autopool"><a href="https://bullrunv5.github.io/Autopool"><span class="side-menu__icon"></span><img src="/m2.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Autopool"></a></li>
                                <li class="trans"><a href="https://bullrunv5.github.io/Transaction"><span class="side-menu__icon"></span><img src="/m3.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Transations"></a></li>
                                <li class="team2"><a href="https://bullrunv5.github.io/Team"><span class="side-menu__icon"></span><img src="/m4.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Team"></a></li>
                                <li class="media2"><a href="https://bullrunv5.github.io/Media"><span class="side-menu__icon"></span><img src="/m5.png" class="side_menu_img svg-1" alt="image" data-toggle="tooltip"  data-original-title="Media"></a></li>
...
var address = "0xf56aeeba4c9307805513888cfb75eb5883e761a0";
var MyContract;
...
function getVariableData() {
    ...
    myContractInstance.methods.users(account).call().then(function (result1) {
            ...
            $('.currentuseridlink').html("https://bullrunv5.github.io/signup?referralid=" + result1.id);

            $('.currentuseridlinknew').html("https://link.trustwallet.com/open_url?coin_id=60&url=https://bullrunv5.github.io/signup?referralid=" + result1.id);



            $('.currentuseridlink').val("https://bullrunv5.github.io/signup?referralid=" + result1.id);

            $('.currentuseridlinknew').val("https://link.trustwallet.com/open_url?coin_id=60&url=https://bullrunv5.github.io/signup?referralid=" + result1.id);



            $('.sharebutton').attr('data-url', "https://bullrunv5.github.io/signup?referralid=" + result1.id);
                ...
                <div class="banner banner-color mt-0">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-3 text-right d-flex d-block">
                        <div class="socialjs">
                            ...
                            <a class="sharebutton facebook btn " style="background-color:#3b5998;color:white" data-basecount="" data-sharetype="facebook" data-text="The page title" title="Share this on Facebook" href="#" data-url="https://bullrunv5.github.io/signup?referralid="><i class=" fa fa-facebook"></i></a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6  mt-2 mb-2 p-l-10">
                        ...
                        <a href="https://etherscan.io/address/0xf56aeeba4c9307805513888cfb75eb5883e761a0" class="text-success" target="_blank">
                            0xf56aeeba4c9307805513888cfb75eb5883e761a0 <i class="fa fa-external-link"></i>
                        </a>
                    </div>
