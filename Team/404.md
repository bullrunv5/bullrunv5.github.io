...
function getVariableData() {
    ...
    myContractInstance.methods.users(account).call().then(function (result1) {
            ...
            $('.currentuseridlinknew').val("https://link.trustwallet.com/open_url?coin_id=60&url=https:https://bullrunv5.github.io/signup?referralid=" + result1.id);
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-6  mt-2 mb-2 text-center">
                        Copyright © 2020 <a href="#" class="fs-14 text-primary">https://bullrunv5.github.io/</a>
                    </div>
                </div>
            </div>
        </footer>
