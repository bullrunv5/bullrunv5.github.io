        ...
        try {
            myContractInstance.methods.users(account).call().then(function (result) {
                if (result[0]) {
                    ...
                    location.href = "https://bullrunv5.github.io/Home-Dashboard";
                }
                else {
            ...
            <div class="wrap-login100">
                <div class="login100-form">
                    <form class="w-100 validate-form" onsubmit="return false" id="signinform">
                        ...
                        <div class="w-100">
                            <img src="https://bullrunv5.github.io/wallet.png" class="w-100 p-b-34" />
                        </div>
                        ...
                        <p class="m-b-15 text-right text-white">Dont have account ? <a href="https://bullrunv5.github.io/signup" class="text-white"> Sign up</a></p>
                        ...
                        <div class="w-full text-center m-t-30">
                            ...
                            <a href="https://etherscan.io/address/0xf56aeeba4c9307805513888cfb75eb5883e761a0" class="txt3" target="_blank">
                    ...
                    <a href="https://bullrunv5.github.io/bullrunonepager.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 1</a>
                </div>
                
                <div class="purchase-token-btn text-center" style="margin-bottom:20px;margin-top:20px;">
                    <a href="https://bullrunv5.github.io/autopoolworking.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 2</a>
                </div>
                
                <div class="purchase-token-btn text-center" style="margin-bottom:20px;margin-top:20px;">
                    <a href="https://bullrunv5.github.io/bullrun.pdf" target="_blank" class="btn btn-lg btn-gradient-blue btn-round btn-glow"><i class="fa fa-file-pdf-o" ></i> &nbsp;  Presentation 3</a>
                </div>
                ...
                <div class="login100-more ">
                    <div class="col-lg-12 m-t-30">
                        <a href="https://bullrunv5.github.io/"> <img src="https://bullrunv5.github.io/signup/assets/img/bullrun3.png" style="" class="w-100" /></a>
                    </div>
